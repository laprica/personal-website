  ...
  render(){
      return (
        <div className="w3-card w3-animate-bottom full-project-card" id="clapsr">
          <h1>This Website</h1>
          <p>Hey, I made this website from scratch using React.js. Still working on it, but it exists!</p>
          
          <div className="w3-display-container">
            <div className="w3-card to-do-list">
            <h3>Website to-do list:</h3>
                <ul>
                    <li>Get links to different 'pages', probably will use react-router or some variation</li>
