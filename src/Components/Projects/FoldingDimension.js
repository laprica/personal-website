      ...
      return (
        <div className="w3-card w3-animate-bottom full-project-card" id="folding-dimension">
          ...
          <div className="video-container">
            <iframe className="video" src="https://www.youtube.com/embed/esQJQq_f2tY" title='FoldingDimensionVideo' frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
          </div>
        </div>
    );
  }
